...
export function printInteractiveMenu() {
    ...
    console.log(SUBTITLE);
    console.log(chalk.dim('  ──────────────────────────────────────────────────────────────'));
    console.log(`  ${VERSION}  ·  ${chalk.green('✓')} SQLite backend  ·  ${chalk.cyan('⚡')} 10 OWASP categories`);
    console.log(TAGLINE);
    console.log('');
    ...
    console.log('');
    console.log(chalk.dim('  ──────────────────────────────────────────────────────────────'));
    console.log(`  ${chalk.gray('Tip:')} ${chalk.dim('`cyberpulse gui`')} ${chalk.gray('to skip this menu and launch the GUI directly')}`);
    console.log('');
}
/** Status icons */
export const STATUS = {
