 ...
 */
export function hardenPrompt(owaspId, originalPrompt) {
 ...
 */
export function getHardeningTemplate(owaspId) {
    return HARDENING_TEMPLATES.find((t) => t.owaspId === owaspId);
}
//# sourceMappingURL=prompt-hardener.js.map