import { z } from 'zod';
export declare const OwaspId: z.ZodEnum<["LLM01", "LLM02", "LLM03", "LLM04", "LLM05", "LLM06", "LLM07", "LLM08", "LLM09", "LLM10"]>;
export type OwaspId = z.infer<typeof OwaspId>;
export declare const Severity: z.ZodEnum<["critical", "high", "medium", "low", "info"]>;
export type Severity = z.infer<typeof Severity>;
export declare const OwaspEntry: z.ZodObject<{
...
export type OwaspEntry = z.infer<typeof OwaspEntry>;
