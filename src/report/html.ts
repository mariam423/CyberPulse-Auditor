import type { RunReport, FindingReport, PatchReport, RetestReport } from './types.js';
...
function statusIcon(closed: boolean): string {
  return closed
    ? '<span style="color:#22c55e;font-size:16px;">✓</span>'
    : '<span style="color:#ef4444;font-size:16px;">✗</span>';
}

function findingsSummary(report: RunReport): string {
...
function findingDetail(f: FindingReport): string {
...
function patchDetail(p: PatchReport): string {
...
function retestDetail(r: RetestReport): string {
